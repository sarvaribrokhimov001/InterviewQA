    ...
    <ProtectedRoute>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-slate-400"> Har bir savolga mos tushadigan batafsil javoblar </p>
        </div>
        ...
        <div className="mb-6">
          <p className="text-sm text-slate-500"> {filteredAnswers.length} ta javob </p>
        </div>

        {filteredAnswers.length === 0 ? (
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-10 text-center">
            <p className="text-slate-400"> Javob topilmadi </p>
          </div>
        ) : (
